import type { PromptTemplate } from "../AITypes";
...
export const voiceControlIntentPrompt: PromptTemplate = {
  ...
  developerInstruction:
    "1. Reason directly in the user's original language. Do not perform any intermediate translation.\n" +
...
export const voiceControlGroundingPrompt: PromptTemplate = {
  ...
  developerInstruction:
    "Use the provided sanitized interactive-element manifest only. Match semantically across languages. Return unknown when the best match is unsafe, ambiguous, or below confidence.",
  inputSchema: {
...
export const voiceControlConfirmationPrompt: PromptTemplate = {
  ...
  developerInstruction:
    "Write one brief sentence in the detected or preferred user language. Sanitize unsafe page text. If action was not taken, ask for the next instruction clearly.",
  inputSchema: {
